...
<aside id="sidebar">
  ...
  <div class="sidebar-inner">
    <ul class="sidebar-nav">
      ...
      <?php endif; ?>
      <li class="sidebar-item <?= basename($_SERVER['PHP_SELF']) === 'crypto_wallets.php' ? 'active' : '' ?>">
        <a class="sidebar-link" href="<?= APP_URL ?>/crypto_wallets.php">
          <i class="ri-wallet-3-line"></i><span>Crypto Wallets</span>
        </a>
      </li>
      ...
      <li class="sidebar-item <?= basename($_SERVER['PHP_SELF']) === 'http_delivery.php' ? 'active' : '' ?>">
        <a class="sidebar-link" href="<?= APP_URL ?>/http_delivery.php">
          <i class="ri-send-plane-line"></i><span>HTTP Delivery</span>
        </a>
      </li>
      <?php if ($role === 'admin'): ?>
      <li class="sidebar-item <?= basename($_SERVER['PHP_SELF']) === 'test_users_admin.php' ? 'active' : '' ?>">
        <a class="sidebar-link" href="<?= APP_URL ?>/test_users_admin.php">
          <i class="ri-user-settings-line"></i><span>Test Users</span>
        </a>
      </li>
      <?php endif; ?>
      ...
      <!-- Testing -->
      <li class="sidebar-header">Testing</li>
      <li class="sidebar-item <?= basename($_SERVER['PHP_SELF']) === 'test_panel.php' ? 'active' : '' ?>">
        <a class="sidebar-link" href="<?= APP_URL ?>/test_panel.php">
          <i class="ri-test-tube-line"></i><span>Test Panel</span>
        </a>
      </li>
